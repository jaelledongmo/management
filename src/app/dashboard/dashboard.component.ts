...
export class DashboardComponent implements OnInit {
  ...
  getData(){
    console.log('Going to find todos')
    this.http.get('http://localhost:3000/projets').pipe().subscribe((res)=>{
      console.log(res)
    })
  }
  ...
  ngOnInit() {
    ...
    this.projets = [{
      id: 1,
      name: "Construction d'un batiment R + 5",
      time: "il y'a 2 jours"
    }, {
      id: 2,
      name: "Creation d'une application",
      time: "il y'a 4 jours"
    }, {
      id: 3,
      name: "Maintenance des appareils",
      time: "il y'a 7 jours"
    }]
